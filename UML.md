...
Il giocatore interagisce con il sistema di gioco nel corso della partita. Le operazioni disponibili coprono l'intero flusso: dalla fase di accesso sino alla conclusione dell'esperienza.
...
L'operatore (il soggetto incaricato della gestione dell'escape room il giorno dell'evento) configura l'esperienza di gioco mediante l'apposito pannello desktop.
...
Il backend esegue operazioni automatiche senza necessità di intervento umano, garantendo il corretto funzionamento del gioco e la conformità normativa.
...
Il diagramma rappresenta le entità principali del sistema e le relative relazioni, mappate direttamente sulle tabelle del database PostgreSQL.
